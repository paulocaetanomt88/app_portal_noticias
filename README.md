...
<p>Neste projeto, configurei o redis para fazer uma consulta no banco de dados apenas uma vez e armazenar esta coleção de dados retornada em um par 'chave' => 'valor' no cache do Redis.</p>
<p>
